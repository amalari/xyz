...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 10, 2015 at 03:12 PM
...
(20, 'afafa', 'aaa', 1, 'aaa', 'afafa', 'afasfasfsa', '<p>afdasa</p>', 2001, '2015-10-21 14:01:31', '2015-11-10 19:09:04', '/uploads/portfolio/1447157343582_Desert.jpg', 7, 3, 1),
...
(11, '/uploads/portfolio/1447157343598_Hydrangeas.jpg', 20),
(12, '/uploads/portfolio/1447157343604_Jellyfish.jpg', 20),
(13, '/uploads/portfolio/1447157343668_Koala.jpg', 20),
(14, '/uploads/portfolio/1447157343690_Lighthouse.jpg', 20),
(15, '/uploads/portfolio//uploads/portfolio/1447157343582_Desert.jpg', 20);
...
(3, 1, 1, 'fdasfsafasfasfafasfasfwetrfa', '<p>gfnjfghjsfgfadgadcvxz</p>', '/uploads/posting/1447164201913_Hydrangeas.jpg', '2015-10-19 08:48:19', '2015-11-10 21:03:31', 1, 0, 0, 1),
...
(18, 1, 1, 'aaa', '<p>aaaaa</p>', '/uploads/posting/undefined', '2015-11-10 21:03:48', '2015-11-10 21:03:48', 1, 0, 0, 1),
(19, 1, 1, 'sss', '<p>sss</p>', '1447164453159_Desert.jpg', '2015-11-10 21:05:06', '2015-11-10 21:10:32', 1, 0, 0, 1),
(20, 1, 1, 'sss', '<p>sss</p>', '1447164546063_Hydrangeas.jpg', '2015-11-10 21:07:57', '2015-11-10 21:10:26', 1, 0, 0, 1),
(21, 1, 1, 'sss', '<p>sss</p>', '', '2015-11-10 21:11:12', '2015-11-10 21:11:20', 1, 0, 0, 1);
...
(25, 'a4@a', '$2a$05$5bqL.Im6l5UqfUJmrt1SkuNYW/z3yQYBeH1LpNf4BLrItnlP3zYki', 'aaa', 'admin', '/uploads/user/1445593182694_CAM00003.jpg', 0);
...
ALTER TABLE `comments`
 ADD PRIMARY KEY (`id`), ADD KEY `portfolio_id` (`portfolio_id`), ADD KEY `post_id` (`post_id`), ADD KEY `parrent_id` (`parrent_id`);

--
-- Indexes for table `portfolios`
--
ALTER TABLE `portfolios`
 ADD PRIMARY KEY (`id`), ADD KEY `category` (`category_id`), ADD KEY `category_id` (`category_id`), ADD KEY `category_id_2` (`category_id`);

--
-- Indexes for table `portfolio_image`
--
ALTER TABLE `portfolio_image`
 ADD PRIMARY KEY (`id`), ADD KEY `portfolios_id` (`portfolio_id`);
